                ...
                <div class="row">
                    ...
                    <div class="col-12 d-flex justify-content-center">
                        ...
                        <ul class="nav nav-pills mb-2">
                            <li class="nav-item">
                                <a class="nav-link" href="<?= base_url(); ?>hrm/travel/request">
                    ...
                    <div class="card">
                        <div class="card-body pb-5 px-sm-5 pt-50">
                            <div class="text-center mb-3 mt-2">
                                <h1 class="mb-1">Travel Completed</h1>
                            </div>
                            <div class="table-responsive">
                                <table class="table datatable-project table-bordered table-striped table-hover mb-2">
                                    <table
                                        class="table datatable-project table-bordered table-striped table-hover mb-2">
                                        <thead class="text-center">
                                            <tr>
                                                <th class="text-nowrap">No</th>
                                                <th class="text-nowrap">Travel Type</th>
