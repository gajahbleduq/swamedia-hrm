    ...
    <div class="app-content content ">
        ...
        <div class="content-wrapper container-xxl p-0">
                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"> Training
                                    </li>
                                </ol>
                            </div>
                        </div>
            ...
            <div class="content-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-8 col-lg-7 col-md-7 order-0 order-md-1">
                            ...
                            <ul class="nav nav-pills mb-2">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" href="<?= base_url(); ?>hrm/training">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <a href="javascript:;" class="btn btn-primary" data-bs-target="#addTraining"
                                        data-bs-toggle="modal">
                                        <i data-feather="plus" class="font-medium-1"></i> Add Training
                                    </a>
                                </div>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-center text-nowrap"><a href="javascript:;"
                                                        class="btn btn-success" data-bs-target="#updateTraining"
                                                        data-bs-toggle="modal">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body pb-5 px-sm-5 pt-50">
                                <div class="text-center mb-2">
                                    <h1 class="mb-1">Add Training</h1>
                                </div>
                                <form id="addTrainingForm" class="row gy-1 pt-75" onsubmit="return false">
                                    <div class="col-12">
                                        <label class="form-label" for="modalAddTrainingName">Training Name</label>
                                        <textarea class="form-control" id="txt_pelatihan" name="txt_pelatihan" rows="2"
                                            placeholder="Database Administration Fundamentals"
                                            data-msg="Please enter your training name"></textarea>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <label class="form-label" for="modalAddOrganization">Organization</label>
                                        <input type="text" id="txt_lembaga" name="txt_lembaga" class="form-control"
                                            placeholder="Microsoft Office Associate"
                                            data-msg="Please enter your training organization" />
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <label class="form-label" for="modalAddDate">Date</label>
                                        <input type="text" id="txt_tanggal" name="txt_tanggal"
                                            class="form-control flatpickr-range" placeholder="2023-01-01 to 2023-12-31"
                                            data-msg="Please enter your training date" />
                                    </div>
                ...
                <div class="modal fade" id="updateTraining" tabindex="-1" aria-hidden="true">
                    <div class="modal-dialog modal-lg modal-dialog-centered modal-edit-user">
                        <div class="modal-content">
                            <div class="modal-header bg-transparent">
                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                            ...
                            <div class="modal-body pb-5 px-sm-5 pt-50">
                                <div class="text-center mb-2">
                                    <h1 class="mb-1">Update Training</h1>
                                </div>
                                <form id="updateTrainingForm" class="row gy-1 pt-75" onsubmit="return false">
                                    <div class="col-12">
                                        <label class="form-label" for="modalAddTrainingName">Training Name</label>
                                        <textarea class="form-control" id="txt_pelatihan" name="txt_pelatihan" rows="2"
                                            placeholder="Database Administration Fundamentals" value=""
                                            data-msg="Please enter your training name"></textarea>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <label class="form-label" for="modalAddOrganization">Organization</label>
                                        <input type="text" id="txt_lembaga" name="txt_lembaga" class="form-control"
                                            placeholder="Microsoft Office Associate" value=""
                                            data-msg="Please enter your training organization" />
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <label class="form-label" for="modalAddDate">Date</label>
                                        <input type="text" id="txt_tanggal" name="txt_tanggal"
                                            class="form-control flatpickr-range" placeholder="2023-01-01 to 2023-12-31"
                                            value="" data-msg="Please enter your training date" />
                                    </div>
                                    <div class="col-12 text-center mt-2 pt-50">
                                        <button type="submit" class="btn btn-primary me-1">Submit</button>
                                        <button type="reset" class="btn btn-outline-secondary" data-bs-dismiss="modal"
