    ...
    <div class="app-content content ">
        ...
        <div class="content-wrapper container-xxl p-0">
            ...
            <div class="content-body">
                <section class="app-user-view-account">
                    <div class="row">
                        ...
                        <div class="col-xl-8 col-lg-7 col-md-7 order-0 order-md-1">
                            ...
                            <!-- Family Info -->
                            <div class="card">
                                <h4 class="card-header">Family</h4>
                                <div class="card-body">
                                    <a href="javascript:;" class="btn btn-primary" data-bs-target="#addFamily"
                                        data-bs-toggle="modal">
                                        <i data-feather="plus" class="font-medium-1"></i> Add Family
                                    </a>
                                </div>
                                <div class="table-responsive">
                                    <table
                                        class="table datatable-project table-bordered table-striped table-hover ms-2 mb-2 me-2">
                                        <thead class="text-center">
                                            <tr>
                                                <th class="text-nowrap">No</th>
                                                <th class="text-nowrap">Full Name</th>
                                                <th class="text-nowrap">Family Status</th>
                                                <th class="text-nowrap">Birthdate</th>
                                                <th class="text-nowrap">Education</th>
                                                <th class="text-nowrap">T-shirt Size</th>
                                                <th class="text-nowrap">T-shirt Model</th>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-center text-nowrap"><a href="javascript:;"
                                                        class="btn btn-success" data-bs-target="#updateFamily"
                                                        data-bs-toggle="modal">
                ...
                <!-- Add Family Modal -->
                <div class="modal fade" id="addFamily" tabindex="-1" aria-hidden="true">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body pb-5 px-sm-5 pt-50">
                                <div class="text-center mb-2">
                                    <h1 class="mb-1">Add Family</h1>
                                </div>
                                <form id="addFamilyForm" class="row gy-1 pt-75" onsubmit="return false">
                                    <div class="col-12">
                                        <label class="form-label" for="modalAddFullName">Fullname</label>
                                        <input type="text" id="txt_nama" name="txt_nama" class="form-control"
                                            placeholder="John Smith" data-msg="Please enter your fullname family" />
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <label class="form-label" for="modalAddSkillLevel">Family Status</label>
                                        <select id="drp_status" name="drp_status" class="select2 form-select">
                                    ...
                                    <div class="col-12 col-md-6">
                                        ...
                                        <input type="text" id="txt_tanggal" name="txt_tanggal"
                                            ...
                                            data-msg="Please enter your birthdate family" />
                                    </div>
                                    <div class="col-12">
                                        <label class="form-label" for="modalAddEducation">Education</label>
                                        <input type="text" id="txt_pendidikan" name="txt_pendidikan"
                                            class="form-control" placeholder="Bachelor's Degree"
                                            data-msg="Please enter your education family" />
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <label class="form-label" for="modalAddTshirtSize">T-shirt Size</label>
                                        <select id="drp_kaos" name="drp_kaos" class="select2 form-select">
                                    ...
                                    <div class="col-12 col-md-6">
                                        <label class="form-label" for="modalAddTshirtModel">T-shirt Model</label>
                                        <select id="drp_model" name="drp_model" class="select2 form-select">
                                            <option value="1">Men's Short Sleeves</option>
                                            <option value="2">Men's Long Sleeves</option>
                                            <option value="3">Women's Short Sleeves</option>
                                            <option value="4">Women's Long Sleeves</option>
                ...
                <!--/ Add Family Modal -->
                <!-- Update Family Modal -->
                <div class="modal fade" id="updateFamily" tabindex="-1" aria-hidden="true">
                    <div class="modal-dialog modal-lg modal-dialog-centered modal-edit-user">
                        <div class="modal-content">
                            <div class="modal-header bg-transparent">
                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                            ...
                            <div class="modal-body pb-5 px-sm-5 pt-50">
                                <div class="text-center mb-2">
                                    <h1 class="mb-1">Update Family</h1>
                                </div>
                                <form id="updateFamilyForm" class="row gy-1 pt-75" onsubmit="return false">
                                    <div class="col-12">
                                        <label class="form-label" for="modalAddFullName">Fullname</label>
                                        <input type="text" id="txt_nama" name="txt_nama" class="form-control"
                                            placeholder="John Smith" data-msg="Please enter your fullname family" />
