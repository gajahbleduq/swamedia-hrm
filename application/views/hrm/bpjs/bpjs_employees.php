        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">BPJS Employees</h2>
                ...
                <div class="row">
                    ...
                    <div class="col-12 d-flex justify-content-center">
                        ...
                        <ul class="nav nav-pills mb-2">
                            <li class="nav-item">
                                <a class="nav-link" href="<?= base_url(); ?>bpjs/form">
                    ...
                    <div class="card">
                        <div class="card-body pb-5 px-sm-5 pt-50">
                            <div class="text-center mb-3 mt-2">
                                <h1 class="mb-1">BPJS Employees </h1>
                            </div>
                                ...
                                <table class="table datatable-project table-bordered table-striped table-hover mb-2">
                                    <thead class="text-center">
                                        <tr>
                                            ...
                                            <th class="text-nowrap">PISA</th>
                                            <th class="text-nowrap">Birthplace</th>
                                            ...
                                            <td class="text-nowrap text-center">
                                                <div class="demo-inline-spacing">
                                                    <div class="form-check form-check-inline">
                                                        <a href="<?= base_url(); ?>bpjs/employees/detail/"
                                                            class="btn btn-secondary w-50 me-1">
                                                            <i data-feather="search" class="font-medium-1"></i> View
                                                        </a>
                                                        <a href="<?= base_url(); ?>bpjs/family/" class="btn btn-info">
                                                            <i data-feather="grid" class="font-medium-1"></i> Family
                                                        </a>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <a href="javascript:;" class="btn btn-success me-1"
                                                            data-bs-target="#updateBpjsEmployees"
                    ...
                    <!-- Update BPJS Employees Modal -->
                    <div class="modal fade" id="updateBpjsEmployees" tabindex="-1" aria-hidden="true">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body pb-5 px-sm-5 pt-50">
                                    <div class="text-center mb-2">
                                        <h1 class="mb-1">Update BPJS Employees</h1>
                                    </div>
                                    <form id="updateBpjsEmployeesForm" class="row gy-1 pt-75" onsubmit="return false">
                                        ...
                                        <div class="col-12 col-md-4">
                                            ...
                                            <input type="text" id="txt_faskesgig" name="txt_faskesgig"
                                                class="form-control" placeholder="Name of Dentist Health Facility"
                                                data-msg="Please enter name of dentist health facility" />
                                        </div>
                                        <div class="col-12 col-md-4">
                                            <label class="form-label" for="family-card">Family Card ID</label>
                                            <input type="number" id="txt_nomorkk" name="txt_nomorkk"
                                                class="form-control" placeholder="Family Card ID"
                                                data-msg="Please enter your family card ID" />
                                        </div>
                                        <div class="col-12 col-md-4">
                                        ...
                                        <div class="col-12 col-md-4">
                                            ...
                                            <input type="number" id="txt_nik" name="txt_nik" class="form-control"
                                                placeholder="NIK/KITAS/KITAP"
                                                data-msg="Please enter your NIK/KITAS/KITAP" />
                                        </div>
                                        <div class="col-12 col-md-4">
                                            <label class="form-label" for="village">Village/Urban Village</label>
                                            <input type="text" id="txt_desalurah" name="txt_desalurah"
                                                class="form-control" placeholder="Sukaluyu"
                                                data-msg="Please enter village/urban village" />
                                        </div>
                                        <div class="col-12 col-md-4">
                                        ...
                                        <div class="col-12 col-md-4">
                                            ...
                                            <input type="text" id="txt_kecamatan" name="txt_kecamatan"
                                                class="form-control" placeholder="Cibeunying Kaler"
                                                data-msg="Please enter sub-district" />
                                        </div>
                                        <div class="col-12 col-md-4">
                                            ...
                                            <div class="demo-inline-spacing">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio"
                                                        name="rb_statuskaryawan" id="rb_statuskaryawan" value="1" />
                                                    <label class="form-check-label" for="full-time">Full-time</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio"
                                                        name="rb_statuskaryawan" id="rb_statuskaryawan" value="2" />
                                                    <label class="form-check-label" for="contract">Contract</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio"
                                                        name="rb_statuskaryawan" id="rb_statuskaryawan" value="3" />
                                        ...
                                        <div class="col-12 col-md-4">
                                            ...
                                            <input type="text" id="txt_provinsi" name="txt_provinsi"
                                                class="form-control" placeholder="West Java"
                                        ...
                                        <div class="col-12 col-md-4">
                                            <div class="col-12 col-md-6 mb-1 position-relative">
                                                ...
                                                <input type="text" id="txt_tanggal" name="txt_tanggal"
                                                    ...
                                                    placeholder="October 14, 2020" data-msg="Please enter birthdate" />
                                            </div>
                                        </div>
                                        <div class="col-12 col-md-4">
                                            <label class="form-label" for="kodepos">Postal Code</label>
                                            <input type="number" id="txt_kodepos" name="txt_kodepos"
                                                class="form-control" placeholder="40123"
                                                data-msg="Please enter postal code" />
                                        </div>
                                        <div class="col-12 col-md-4">
                                            <label class="form-label" for="insurance-policy-number">Insurance Policy
                                                Number</label>
                                            <input type="number" id="txt_nopolis" name="txt_nopolis"
                                                class="form-control" placeholder="Insurance Policy Number"
                                        ...
                                        <div class="col-12 col-md-4">
                                            <label class="form-label" for="province">Province</label>
                                            <input type="text" id="txt_provinsi2" name="txt_provinsi2"
                                                class="form-control"
                                        ...
                                        <div class="col-12 col-md-4">
                                            ...
                                            <div class="demo-inline-spacing">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="rb_status"
                                                        id="rb_status" value="1" />
                                                    <label class="form-check-label" for="married">Married</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="rb_status"
                                                        id="rb_status" value="2" />
                                                    <label class="form-check-label" for="single">Single</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="rb_status"
                                                        id="rb_status" value="3" />
                                        ...
                                        <div class="col-12 col-md-4">
                                            <label class="form-label" for="province">City/District</label>
                                            <input type="text" id="txt_kotakab2" name="txt_kotakab2"
                                                class="form-control"
                                                placeholder="For the choice of level 1 health facilities"
                                                data-msg="Please enter province" />
                                        </div>
                                        ...
                                        <div class="col-12 col-md-4">
                                            ...
                                            <textarea class="form-control" id="txt_alamat" name="txt_alamat" rows="2"
                                                placeholder="Jl. Sido Mulyo No.29"
                                                data-msg="Please enter address"></textarea>
                                        </div>
                                        <div class="col-12 col-md-4">
                                            <label class="form-label" for="health-facility">Name of Level 1 Health
                                                Facility</label>
                                            <input type="text" id="txt_faskessatu" name="txt_faskessatu"
                                                class="form-control" placeholder="Name of level 1 health facility"
                                                data-msg="Please enter name of level 1 health facility" />
                                        </div>
                                        <div class="col-12 col-md-4">
                                            <label class="form-label" for="passport">Passport</label>
                                            <input type="number" id="txt_pasport" name="txt_pasport"
